		...
		if (!disabled)
		{
			...
			{ 
				...
				if(gameObject.name == "C1_Image"){
					...
					csChaperStageNum.Chapter = 2;
				}else if(gameObject.name == "C3_Image"){
					csChaperStageNum.Chapter = 3;
				}else if(gameObject.name == "C4_Image"){
					csChaperStageNum.Chapter = 4;
				}
				if(gameObject.name == "S1_Image"){
					csChaperStageNum.Stage = 1;
					Application.LoadLevel ("ActSelectScene");
				}else if(gameObject.name == "S2_Image"){
					csChaperStageNum.Stage = 2;
					Application.LoadLevel ("ActSelectScene");
				}else if(gameObject.name == "S3_Image"){
					csChaperStageNum.Stage = 3;
					Application.LoadLevel ("ActSelectScene");
				}
				if(gameObject.name == "S t a r t"){
					if(csChaperStageNum.Chapter == 1){
						...
						else if(csChaperStageNum.Stage == 3){
